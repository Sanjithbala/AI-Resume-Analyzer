...
export default function Dashboard({ result, resumeText, fileName, onReset }: Props) {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#f8fafc', color: '#0f172a' }}>
      ...
      {/* Top Bar */}
      <header className="sticky top-0 z-40" style={{ borderBottom: '1px solid #e2e8f0', background: '#ffffff' }}>
      ...
      <div className="max-w-7xl mx-auto flex">
        {/* Sidebar — Desktop */}
        <aside className="hidden lg:block w-56 flex-shrink-0 min-h-[calc(100vh-57px)] sticky top-[57px]" style={{ borderRight: '1px solid #e2e8f0', background: '#ffffff' }}>
